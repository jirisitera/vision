...
function createShootingStar() {
  ...
  const nextAppearance = Math.random() * 10000 + 10000;
...
function drawShootingStar() {
  ...
  ctx.lineTo(shootingStar.x - shootingStar.dx * shootingStar.length, shootingStar.y - shootingStar.dy * shootingStar.length);
  ctx.stroke();
  ctx.closePath();
}
